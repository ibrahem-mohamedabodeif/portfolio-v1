...
export default function ProjectsSec() {
  return (
    <div
      id="projects-section"
      className="px-7 lg:px-20 py-20 bg-[#e5e5e5] rounded-t-[100px] text-center"
    >
      <div
        aria-label="header"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 justify-between mt-28 px-10">
        <Link href={`/projects?project=Homely`}>
          <div className="flex flex-col overflow-hidden">
            <div className="relative w60 lg:w-96 h-40 lg:h-48">
              <Image
                src={"/projects images/homely/image1.png"}
                fill
                alt="homely"
        ...
        <Link href={`/projects?project=PegasusE-commerce`}>
          <div className="flex flex-col overflow-hidden">
            <div className="relative w60 lg:w-96 h-40 lg:h-48">
              <Image
                src={"/projects images/e-commerce/e-commerce.png"}
                fill
                alt="pegasus"
                className="rounded-lg object-fill"
              />
        ...
        <Link href={`/projects?project=BuildHub`}>
          <div className="flex flex-col overflow-hidden">
            <div className="relative w60 lg:w-96 h-40 lg:h-48">
              <Image
                src={"/projects images/buildhub/buildhub.png"}
                fill
                alt="build-hub"
                className="rounded-lg object-fill"
              />
